# Taken from https://github.com/TheCacophonyProject/wpasupplicantconf/blob/master/wpasupplicantconf.py.
# We can replace this if they make it into a pip package (please!)
